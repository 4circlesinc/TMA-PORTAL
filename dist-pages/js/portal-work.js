...
(function () {
    ...
    return '<div class="tma-portal-sig-wizard__steps" role="list">' +
      SIG_WIZARD_STEPS.map(function (step, i) {
        ...
        return (i ? '<span class="tma-portal-sig-wizard__step-line' + (done ? ' is-done' : '') + '" aria-hidden="true"></span>' : '') +
          ...
          (done
            ? '<img src="/TMA-PORTAL/images/icons/phosphor/CheckCircle.svg" alt="">'
            : '<img src="/TMA-PORTAL/images/icons/phosphor/' + step.icon + '.svg" alt="">') +
          '</span>' +
  ...
  function sigFieldCard(label, icon, action) {
    return '<button type="button" class="tma-portal-sig-wizard__field-card" data-sig-field="' + ui().esc(action) + '">' +
      '<span class="tma-portal-sig-wizard__field-card-icon"><img src="/TMA-PORTAL/images/icons/phosphor/' + icon + '.svg" alt=""></span>' +
  ...
  function renderSignatureWizardReviewStep(record) {
    ...
    return '<section class="tma-portal-sig-wizard__review-step">' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/FolderFilled.svg" alt="" width="20" height="20">' +
  ...
  function renderSignatureWizardStep(record) {
    ...
    return '<section class="tma-portal-sig-wizard__section">' +
      ...
      (readOnly ? '' : '<button type="button" class="tma-portal-sig-wizard__doc-remove" data-sig-wizard-remove-doc aria-label="Remove document"><img src="/TMA-PORTAL/images/icons/phosphor/X.svg" alt=""></button>') +
  ...
  function renderSignatureWizard(record) {
    ...
    return '<div class="tma-portal-sig-wizard' + wizardMod + '">' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/X.svg" alt=""></button>' +
      '</header>' +
  ...
  function renderSignatures() {
    ...
    el.innerHTML =
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/DotsThree.svg" alt=""></button>' +
      '</div>' +
