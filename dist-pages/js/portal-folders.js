...
(function () {
  ...
  function starBtn(item) {
    return '<button type="button" class="tma-portal-icon-btn tma-portal-star' + (item.starred ? ' is-starred' : '') + '"' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/' + (item.starred ? 'StarFilled' : 'Star') + '.svg" alt="" width="16" height="16">' +
      '</button>';
  }
  ...
  function renderFileBoxEmpty() {
    return '<div class="tma-portal-filebox-empty">' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/FolderNotchOpen.svg" alt="" width="64" height="64">' +
      '</div>' +
  ...
  function itemIconSrc(f) {
    ...
    if (f.kind === 'filebox') return '/TMA-PORTAL/images/icons/phosphor/ArchiveTray.svg';
    return '/TMA-PORTAL/images/icons/phosphor/FolderFilled.svg';
  }
  ...
  function renderItemNameCell(f) {
    ...
    return '<td><span class="tma-portal-avatar-cell">' + icon +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/PencilSimple.svg" alt="" width="16" height="16"></button>' +
      '</span></span></td>';
  }
  ...
  var SELECTION_ICON = '/TMA-PORTAL/images/icons/phosphor/';
  var SELECTION_LINE = '/TMA-PORTAL/images/icons/tma/Line-16.svg';
  ...
  function renderFileBox(s) {
    ...
    return '<div class="tma-portal-head">' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/Plus.svg" alt=""></button>' +
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/UploadSimple.svg" alt=""><span>Upload</span></button>' +
      '<button type="button" class="tma-portal-fab-menu__item" role="menuitem" data-filebox-action="request">' +
      '<img src="/TMA-PORTAL/images/icons/phosphor/DownloadSimple.svg" alt=""><span>Request Files</span></button>' +
      '</div></div>' +
      (items.length
  ...
  function render() {
    ...
    if (fab && fabMenu) {
      function setFabOpen(open) {
        ...
        fab.querySelector('img').src = '/TMA-PORTAL/images/icons/phosphor/' + (open ? 'X' : 'Plus') + '.svg';
      }
  ...
  function ensureDropzone() {
    ...
    dropzone.innerHTML =
      ...
      '<img src="/TMA-PORTAL/images/icons/phosphor/CloudUpload.svg" alt="" width="96" height="96">' +
      '</div>' +
