...
(function () {
  ...
  function render() {
    return '<div class="tma-dash__grid" data-node-id="32546:96097">' +
      ...
      '<img class="tma-dash__card-ico" src="/TMA-PORTAL/images/icons/phosphor/FolderNotch.svg" alt=""></div>' +
      '<div class="tma-dash__card-row"><div class="tma-dash__card-value">29</div>' +
      '<div class="tma-dash__card-delta"><span class="tma-dash__card-delta-text">+11.02%</span><img src="/TMA-PORTAL/images/icons/tma/ArrowRise.svg" alt="up"></div></div></article>' +
      ...
      '<img class="tma-dash__card-ico" src="/TMA-PORTAL/images/icons/phosphor/ListChecks.svg" alt=""></div>' +
      '<div class="tma-dash__card-row"><div class="tma-dash__card-value">715</div>' +
      '<div class="tma-dash__card-delta"><span class="tma-dash__card-delta-text">-0.03%</span><img src="/TMA-PORTAL/images/icons/tma/ArrowFall.svg" alt="down"></div></div></article>' +
      '<article class="tma-dash__card tma-dash__card--blue">' +
      '<div class="tma-dash__card-head"><span class="tma-dash__card-label">Members</span>' +
      '<img class="tma-dash__card-ico" src="/TMA-PORTAL/images/icons/phosphor/UsersThree.svg" alt=""></div>' +
      '<div class="tma-dash__card-row"><div class="tma-dash__card-value">31</div>' +
      '<div class="tma-dash__card-delta"><span class="tma-dash__card-delta-text">+15.03%</span><img src="/TMA-PORTAL/images/icons/tma/ArrowRise.svg" alt="up"></div></div></article>' +
      '<article class="tma-dash__card tma-dash__card--purple">' +
      '<div class="tma-dash__card-head"><span class="tma-dash__card-label">Productivity</span>' +
      '<img class="tma-dash__card-ico" src="/TMA-PORTAL/images/icons/phosphor/BatteryCharging.svg" alt=""></div>' +
      '<div class="tma-dash__card-row"><div class="tma-dash__card-value">93.8%</div>' +
      '<div class="tma-dash__card-delta"><span class="tma-dash__card-delta-text">+6.08%</span><img src="/TMA-PORTAL/images/icons/tma/ArrowRise.svg" alt="up"></div></div></article>' +
      '</div>' +
      ...
      '<div class="tma-dash__td"><span class="tma-dash__avatars"><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarMale05.png" alt=""></span></div>' +
      ...
      '<div class="tma-dash__td"><span class="tma-dash__avatars"><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarAbstract01.png" alt=""><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarFemale05.png" alt=""></span></div>' +
      ...
      '<div class="tma-dash__td"><span class="tma-dash__avatars"><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarFemale04.png" alt=""><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarMale05.png" alt=""><span class="tma-dash__avatar tma-dash__avatar--more">+3</span></span></div>' +
      ...
      '<div class="tma-dash__td"><span class="tma-dash__avatars"><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/Avatar3d03.png" alt=""><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarAbstract02.png" alt=""></span></div>' +
      ...
      '<div class="tma-dash__td"><span class="tma-dash__avatars"><img class="tma-dash__avatar" src="/TMA-PORTAL/images/avatars/AvatarMale01.png" alt=""></span></div>' +
