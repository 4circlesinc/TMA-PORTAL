(function () {
  ...
  function ensureSearchChrome(searchWrap) {
    ...
    if (!searchWrap.querySelector('[data-search-clear]')) {
      ...
      clearBtn.innerHTML = '<img src="/TMA-PORTAL/images/icons/tma/Xcircle.svg" class="tma-function-bar__search-clear-icon" width="16" height="16" alt="">';
    ...
    if (!searchWrap.querySelector('.tma-function-bar__search-spinner')) {
      ...
      spinner.innerHTML = '<img src="/TMA-PORTAL/images/icons/tma/Loading-16.svg" width="20" height="20" alt="">';
