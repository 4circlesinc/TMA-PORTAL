    ...
    return '<div class="tma-portal-head"><div>' +
      ...
      HOME_LINKS.map(function (l) {
        return '<button type="button" class="tma-portal-tpl-card" data-people-link="' + l.nav + '" data-people-title="' + ui().esc(l.title) + '" style="cursor:pointer;text-align:left;font-family:inherit">' +
          '<div class="tma-portal-tpl-card__preview"><img src="/TMA-PORTAL/images/icons/phosphor/' + l.icon + '.svg" alt=""></div>' +
  ...
  function renderEmployees() {
    ...
    var rows = list.map(function (p) {
      return '<tr>' +
        ...
        '<img src="/TMA-PORTAL/images/avatars/AvatarByewind.png" alt="">' +
        ...
        '<button type="button" class="tma-portal-icon-btn" data-people-manage="' + p.id + '" title="Manage" aria-label="Manage ' + ui().esc(p.firstName) + '"><img src="/TMA-PORTAL/images/icons/phosphor/GearSix.svg" alt=""></button>' +
        '</div></td></tr>';
  ...
  function renderGroups() {
    ...
    var rows = s.distributionGroups.map(function (g) {
      return '<tr><td><strong>' + ui().esc(g.name) + '</strong></td>' +
        ...
        '<td><div class="tma-portal-row-actions">' +
        '<button type="button" class="tma-portal-icon-btn" data-people-group-delete="' + g.id + '" title="Delete group" aria-label="Delete group"><img src="/TMA-PORTAL/images/icons/phosphor/Trash.svg" alt=""></button>' +
        '</div></td></tr>';
    }).join('');
