...
(function () {
  ...
  function renderAssignees(project) {
    ...
    if (project.avatarGroup) {
      project.avatarGroup.slice(0, 2).forEach(function (key) {
        html += '<img class="tma-dash__avatar tma-dash__avatar--28" src="/TMA-PORTAL/images/avatars/' + escapeHtml(key) + '.png" alt="">';
      });
      ...
      html += '<img class="tma-dash__avatar tma-dash__avatar--28" src="/TMA-PORTAL/images/avatars/' + escapeHtml(project.avatar) + '.png" alt="">';
    }
    html += '</div>';
    return html;
  }
  ...
  function renderListLogo(project) {
    var src = (window.TMACard && window.TMACard.brandLogoSrc)
      ...
      : '/TMA-PORTAL/images/icons/brands/' + (project.logoIcon || 'Figma') + '40.svg';
