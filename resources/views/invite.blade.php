    ...
    <section class="tma-auth__panel" aria-labelledby="invite-title">
      ...
      <div class="tma-auth__panel-body">
        ...
        @if ($state === 'expired')
          ...
          <a class="tma-auth__submit" href="mailto:support@tmantoinelaw.com?subject={{ rawurlencode('New portal invitation request') }}">Request a new invitation</a>
        ...
        @elseif ($state === 'cancelled')
          ...
          <a class="tma-auth__submit" href="mailto:support@tmantoinelaw.com">Contact support</a>
        ...
        @elseif ($state === 'registration-closed')
          ...
          <a class="tma-auth__submit" href="mailto:support@tmantoinelaw.com?subject={{ rawurlencode('Portal account setup') }}">Contact support</a>
          <p class="tma-auth__alt-link"><a href="{{ url('/auth/login') }}">Go to sign in</a></p>
        ...
        @unless ($dead)
          <p class="tma-auth__alt-link">
            ...
            @endif
            <a href="mailto:support@tmantoinelaw.com">Contact support</a>
          </p>
        @endunless
      </div>
...
@push('scripts')
  <script src="/js/legal-accept.js?v=2"></script>
@endpush
