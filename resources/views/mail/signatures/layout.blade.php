{{-- Plain, inlined styles: mail clients don't honour stylesheets, and this
     needs to survive Outlook as well as it renders in Gmail. --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>@yield('title', 'Signature request')</title>
</head>
