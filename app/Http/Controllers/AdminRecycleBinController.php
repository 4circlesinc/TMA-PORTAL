 ...
 *
 * Soft-deleted files, folders, user accounts, clients, CIP applications,
 * signatures, groups, calendar events, and message attachments. Email and chat
 * messages themselves are excluded.
 */
