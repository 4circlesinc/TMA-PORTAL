    ...
    private static function companies(): array
    {
        ...
        return [
            ...
            'service-provider-admin-added' => [
                'name' => 'Added as Service Provider admin',
                'category' => 'Companies',
                'when' => 'Sent when someone is assigned to a service provider as an admin for the first time.',
                'variables' => [
                    'name' => "The recipient's first name, when known",
                    'company' => "The company's name",
                    'url' => 'Where the button goes',
                    'addedBy' => 'Who assigned them, when known',
                ],
                'sample' => ['name' => 'Priya', 'company' => 'Galaxy Consultants', 'addedBy' => 'Vernon Francis'],
                'sampleExtras' => ['details' => [['Company', 'Galaxy Consultants'], ['Your role', 'Service Provider admin'], ['Added by', 'Vernon Francis']]],
                'copy' => [
                    'subject' => 'You have been added to {{company}} as a Service Provider admin',
                    'preheader' => 'You have been added to {{company}} as a Service Provider admin.',
                    'eyebrow' => 'Service provider access',
                    'greeting' => self::HELLO,
                    'title' => 'You have been added as a Service Provider admin',
                    'lead' => '{{#addedBy}}{{addedBy}} has added you{{/addedBy}}{{^addedBy}}You have been added{{/addedBy}} to {{company}} as a Service Provider admin.',
                    'body' => "Your access is already active — you do not need to accept an invitation.\n\nAs a Service Provider admin for {{company}} you can invite and remove people at the firm, and view and work on Citizenship by Investment applications filed by {{company}}, including documents, comments and status updates.\n\nSign in to the portal to get started.",
                    'button' => 'Open the portal',
                    'footNote' => "If you weren't expecting this change, contact us at support@tmantoinelaw.com.",
                ],
            ],
            'service-provider-contact-added' => [
                'name' => 'Added as service provider contact',
                'category' => 'Companies',
                'when' => 'Sent when someone is assigned to a service provider as a contact for the first time.',
                'variables' => [
                    'name' => "The recipient's first name, when known",
                    'company' => "The company's name",
                    'url' => 'Where the button goes',
                ...
                'sample' => ['name' => 'Priya', 'company' => 'Galaxy Consultants', 'addedBy' => 'Vernon Francis'],
                'sampleExtras' => ['details' => [['Company', 'Galaxy Consultants'], ['Your role', 'Service provider contact'], ['Added by', 'Vernon Francis']]],
                'copy' => [
                    'subject' => 'You have been added to {{company}} as a service provider contact',
                    'preheader' => 'You have been added to {{company}} as a service provider contact.',
                    'eyebrow' => 'Service provider access',
                    'greeting' => self::HELLO,
                    'title' => 'You have been added as a service provider contact',
                    'lead' => '{{#addedBy}}{{addedBy}} has added you{{/addedBy}}{{^addedBy}}You have been added{{/addedBy}} to {{company}} as a service provider contact.',
                    'body' => "Your access is already active — you do not need to accept an invitation.\n\nAs a service provider contact for {{company}} you can view and work on Citizenship by Investment applications filed by {{company}}, including documents, comments and status updates.\n\nSign in to the portal to get started.",
                    'button' => 'Open the portal',
                    'footNote' => "If you weren't expecting this change, contact us at support@tmantoinelaw.com.",
                ],
            ],
            'service-provider-admin-switched' => [
                'name' => 'Switched as Service Provider admin',
                'category' => 'Companies',
                'when' => 'Sent when a Service Provider admin is moved to a different firm.',
                'variables' => [
                    'name' => "The recipient's first name, when known",
                    'company' => "The company's name",
                    'url' => 'Where the button goes',
                    'switchedBy' => 'Who switched them, when known',
                    'previousCompany' => 'The firm they were moved from, when known',
                ],
                'sample' => ['name' => 'Priya', 'company' => 'Bluemina Partners', 'switchedBy' => 'Vernon Francis', 'previousCompany' => 'Galaxy Consultants'],
                'sampleExtras' => ['details' => [['Company', 'Bluemina Partners'], ['Your role', 'Service Provider admin'], ['Previous firm', 'Galaxy Consultants'], ['Switched by', 'Vernon Francis']]],
                'copy' => [
                    'subject' => 'Your service provider has been switched to {{company}}',
                    'preheader' => 'Your service provider has been switched to {{company}}.',
                    'eyebrow' => 'Service provider access',
                    'greeting' => self::HELLO,
                    'title' => 'Your service provider has been switched',
                    'lead' => '{{#switchedBy}}{{switchedBy}} has switched your service provider{{/switchedBy}}{{^switchedBy}}Your service provider has been switched{{/switchedBy}} to {{company}}. You are a Service Provider admin there.',
                    'body' => "{{#previousCompany}}Your access through {{previousCompany}} has ended. {{/previousCompany}}As a Service Provider admin for {{company}} you can invite and remove people at the firm, and view and work on Citizenship by Investment applications filed by {{company}}, including documents, comments and status updates.\n\nSign in to the portal to see what you now have access to.",
                    'button' => 'Open the portal',
                    'footNote' => "If you weren't expecting this change, contact us at support@tmantoinelaw.com.",
                ],
            ],
            'service-provider-contact-switched' => [
                'name' => 'Switched as service provider contact',
                'category' => 'Companies',
                'when' => 'Sent when a service provider contact is moved to a different firm.',
                'variables' => [
                    'name' => "The recipient's first name, when known",
                    'company' => "The company's name",
                    'url' => 'Where the button goes',
                ...
                'sample' => ['name' => 'Priya', 'company' => 'Bluemina Partners', 'switchedBy' => 'Vernon Francis', 'previousCompany' => 'Galaxy Consultants'],
                'sampleExtras' => ['details' => [['Company', 'Bluemina Partners'], ['Your role', 'Service provider contact'], ['Previous firm', 'Galaxy Consultants'], ['Switched by', 'Vernon Francis']]],
                'copy' => [
                    'subject' => 'Your service provider has been switched to {{company}}',
                    'preheader' => 'Your service provider has been switched to {{company}}.',
                    'eyebrow' => 'Service provider access',
                    'greeting' => self::HELLO,
                    'title' => 'Your service provider has been switched',
                    'lead' => '{{#switchedBy}}{{switchedBy}} has switched your service provider{{/switchedBy}}{{^switchedBy}}Your service provider has been switched{{/switchedBy}} to {{company}}. You are a service provider contact there.',
                    'body' => "{{#previousCompany}}Your access through {{previousCompany}} has ended. {{/previousCompany}}As a service provider contact for {{company}} you can view and work on Citizenship by Investment applications filed by {{company}}, including documents, comments and status updates.\n\nSign in to the portal to see what you now have access to.",
                    'button' => 'Open the portal',
                    'footNote' => "If you weren't expecting this change, contact us at support@tmantoinelaw.com.",
                ],
            ],
...
Children receive a passport and owe the same originals except marriage and divorce certificates. There is no sponsor checklist at this stage.',
        ...
        return [
            ...
            'cip-ready-to-submit' => [
                ...
                'category' => 'CIP Applications',
                'when' => 'Sent to the provider side when the file is moved to Ready to Submit, asking them to confirm. '.$when,
                'variables' => $vars,
                'sample' => $sample,
                'sampleExtras' => $details,
                'copy' => [
                    ...
                    'lead' => '{{applicant}}’s file is ready to submit. Confirm submission to lock the original package.',
                    'body' => '{{applicant}}’s file ({{provider}}) is ready to submit. Confirm submission to lock the original package. After that, the originals cannot be replaced; further Unit requests go through Additional Documents.',
            ...
            'cip-dd-query' => [
                'name' => 'DD Query',
                'category' => 'CIP Applications',
                'when' => 'Sent to the provider side when the Unit asks for more during a background check. '.$when,
                'variables' => $vars,
                'sample' => $sample,
                'sampleExtras' => $details,
                'copy' => [
                    'preheader' => '{{number}} has a DD query, the Unit has requested additional documents.',
                    'eyebrow' => 'CIP Applications',
                    'greeting' => self::CIP_HI,
                    'title' => '{{number}} has a DD query',
                    'lead' => 'The Unit has requested additional documents on {{applicant}}’s file during the background check. Upload them through DD Query Responses in Additional Documents.',
                    'body' => 'Use the DD Query Responses folder on {{applicant}}’s application ({{provider}}). Do not replace files in the original submission package.',
                    'button' => 'Open DD Query Responses',
                    'footNote' => self::CIP_FOOT,
                ],
            ],
            'cip-new-appeal' => [
                'name' => 'Appeal lodged',
                'category' => 'CIP Applications',
                'when' => 'Sent to the provider side when an appeal is lodged against a decision. '.$when,
                'variables' => $vars,
                'sample' => $sample,
                'sampleExtras' => $details,
                'copy' => [
                    'preheader' => 'An appeal has been lodged on {{number}}.',
                    'eyebrow' => 'CIP Applications',
                    'greeting' => self::CIP_HI,
                    'title' => 'An appeal has been lodged on {{number}}',
                    'lead' => 'The decision on {{applicant}}’s file is being appealed. Supporting documents go in Appeal Documents.',
                    'body' => 'Use the Appeal Documents folder on {{applicant}}’s application ({{provider}}) for everything the appeal needs. While the file is under appeal that folder is the only one open for uploads, so the bundle that goes to the Unit is exactly what was meant to go.',
                    'button' => 'Open Appeal Documents',
                    'footNote' => self::CIP_FOOT,
                ],
            ],
            'cip-appeal-ready' => [
                'name' => 'Appeal ready to confirm',
                'category' => 'CIP Applications',
                'when' => 'Sent to the provider side when the appeal is ready and needs their confirmation. '.$when,
                'variables' => $vars,
                'sample' => $sample,
                'sampleExtras' => $details,
                'copy' => [
                    'preheader' => '{{number}}’s appeal is ready — please confirm.',
                    'eyebrow' => 'CIP Applications',
                    'greeting' => self::CIP_HI,
                    'title' => '{{number}}’s appeal is ready',
                    'lead' => 'The appeal on {{applicant}}’s file is ready to go. Please confirm everything is right on your end.',
                    'body' => 'Check the Appeal Documents folder on {{applicant}}’s application ({{provider}}). If anything is missing or wrong, add it now — once you confirm, the appeal is submitted to the Unit and the bundle is what they receive.',
                    'button' => 'Review the appeal',
                    'footNote' => self::CIP_FOOT,
                ],
            ],
            'cip-appeal-submitted' => [
                'name' => 'Appeal submitted',
                'category' => 'CIP Applications',
                'when' => 'Sent to the provider side when the appeal has gone to the Unit. '.$when,
                'variables' => $vars,
                'sample' => $sample,
                'sampleExtras' => $details,
                'copy' => [
                    'preheader' => '{{number}}’s appeal has been submitted to the Unit.',
                    'eyebrow' => 'CIP Applications',
                    'greeting' => self::CIP_HI,
                    'title' => '{{number}}’s appeal has been submitted',
                    'lead' => 'The appeal on {{applicant}}’s file has gone to the Unit. Nothing further is needed for now.',
                    'body' => 'The appeal on {{applicant}}’s application ({{provider}}) is with the Unit. You will be told as soon as they answer it; if they ask for anything in the meantime it goes in Appeal Documents.',
                    'button' => 'Open the application',
                    'footNote' => self::CIP_FOOT,
                ],
            ],
