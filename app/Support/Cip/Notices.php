...
class Notices
{
    ...
    private static function postcard(
        ...
        return match ($to) {
            ...
            Status::DD_QUERY => Postcards::cipDdQuery(
                $facts, $url, $application->dd_query_received_at?->toDateString(), $recipientName, $actor, $subject,
                $message,
            ),
    ...
    private static function bellMessage(CipApplication $application, string $to, array $facts): string
    {
        return match ($to) {
            ...
            Status::DD_QUERY => 'The Unit has requested additional documents during the background check.',
