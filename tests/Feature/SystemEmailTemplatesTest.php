...
class SystemEmailTemplatesTest extends TestCase
{
    ...
    public function test_an_edit_changes_what_is_sent(): void
    {
        ...
        $this->assertStringContainsString('mailto:support@tmantoinelaw.com', $mail->payload['bodyHtml']);
    ...
    {
        $html = Markup::html(
            "See **{{name}}** at [the portal]({{url}}) or https://tma.test — write support@tmantoinelaw.com.\n\n- one\n- two",
        ...
        $this->assertStringContainsString('<a href="mailto:support@tmantoinelaw.com"', $html);
